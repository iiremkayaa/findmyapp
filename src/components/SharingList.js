    ...
    const showPopUp = () => {
        return (
            <Modal show={show} onHide={handleClose} animation={true} centered backdrop={false} >
                ...
                <Modal.Footer>
                    <button onClick={sendCommentChange} style={{ fontWeight: "400", fontSize: "15px", borderWidth: "1px", borderRadius: "5px", borderColor: "white", color: "white", backgroundColor: "#3e414d", padding: "3px", paddingLeft: "30px", paddingRight: "30px" }}>
                        SEND
                </button>
                        ...
                        <div key={index} style={{ margin: "10px", backgroundColor: "#f2edf1", borderRadius: "5px", padding: "5px" }}>
                            <div style={{ display: "inline-block", width: "100%" }}>
                                <div style={{ display: "inline", float: "left" }}>
                                    <i className="far fa-user" style={{ width: "20px", height: "20px", color: "#1a2631", fontWeight: "600" }}></i>
                                </div>
            ...
            <Desktop>
                <div id="sharings">
                    ...
                    {sharings.map((sharings, index) => (
                        <div key={index} id="sharing" style={{backgroundColor:"#3e414d",boxShadow:"none"}} >
                                    ...
                                    <div style={{ width: "100%", display: "inline-block" }}>
                                        ...
                                        <div style={{ display: "flex", float: "left" }}>
                                            <button style={{ backgroundColor: "Transparent", border: "none", display: "inline", padding: 0 }} onClick={(event) => { showSuggestion(event, sharings.sharingId) }}>
                                                <h2 id="suggestion-header" style={{color:"white"}} >Suggestions</h2>
                                            </button>
                                        </div>
                                        <div style={{ display: "flex", float: "right", margin: 0, padding: 0 }}>
                                            ...
                                            <div style={{ borderColor: "white" }}>
                                                <button style={{ backgroundColor: "Transparent", border: "none", display: "inline" }} onClick={(event) => { makeSuggestion(event, sharings.sharingId) }}><i className="far fa-comment " style={{ color: "white", fontSize: "20px" }}></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style={{ width: "100%", verticalAlign: "middle", overflow: "auto", }}>
                                    <div style={{ width: "100%", display: "inline-block" }}>
                                        ...
                                        <div style={{ display: "flex", float: "right", margin: 0, padding: 0 }}>
                                            ...
                                            <div style={{ borderColor: "white" }}>
                                                <button style={{ backgroundColor: "Transparent", border: "none", display: "inline" }} onClick={(event) => { makeSuggestion(event, sharings.sharingId) }}><i className="far fa-comment " style={{ color: "white", fontSize: "12px" }}></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
