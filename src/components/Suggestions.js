                    ...
                    {suggestions.map((suggestion, index) => (
                        <div key={index} id="suggestion-mb" >
                            <div style={{ width: "100%", display: "inline-block" }}>
                                ...
                                <div style={{ display: "inline", float: "right", color: "black", fontSize: "14px", fontWeight: "500" }}>{suggestion.comment.date}</div>
                            </div>
                            <div style={{ width: "100%", display: "inline-block" }}>
                                {/*<div style={{display:"flex",float:"left"}}>
                                {getSharing(suggestion.comment.sharingId)}
                                ...
                                <div style={{ display: "flex", float: "left" }}><h2 style={{ color: "black", fontSize: "15px" }}>{suggestion.comment.comment}</h2></div>
                                <div style={{ display: "flex", float: "right" }}>
                                    <button style={{ backgroundColor: "Transparent", border: "none", display: "inline" }} onClick={(event) => { deleteComment(event, suggestion.commentId) }}><i className="fas fa-trash-alt" style={{ color: "rgb(61,83,119)", fontSize: "14px" }}></i></button>
                                </div>
                            </div>
                        </div>
                    ))}
